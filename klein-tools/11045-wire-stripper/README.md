# Klein Tools 11045 — Wire stripper/cutter
...
| | |
|---|---|
| Catalogue length (nominal) | 159 mm |
| Width | 98.2 mm (derived from the photo) |
| Traced (raw) | 158.94 x 98.19 mm |
| Pocket | 161.83 x 101.12 mm |
| Cutout depth | 20 mm |
| Bin size | 3x5 units (125.38 x 209.38 mm) |
| Clearance | 1.5 mm radial |
| Lip margin | 20.82 mm per end |
...
```
python3 ../../scripts/make_tool.py <photo> klein-11045 --length 159 --outdir .
