# Klein Tools D201-7NE — Lineman's pliers
...
| | |
|---|---|
| Catalogue length (nominal) | 189 mm |
| Width | 44.0 mm (derived from the photo) |
| Traced (raw) | 188.93 x 43.99 mm |
| Pocket | 191.83 x 46.95 mm |
| Cutout depth | 20 mm |
| Bin size | 2x5 units (83.38 x 209.38 mm) |
| Clearance | 1.5 mm radial |
| Lip margin | 5.82 mm per end |
...
```
python3 ../../scripts/make_tool.py <photo> klein-d201-7ne --length 189 --outdir .
