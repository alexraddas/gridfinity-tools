# Klein Tools 11053 — Wire stripper/cutter
...
| | |
|---|---|
| Catalogue length (nominal) | 181 mm |
| Width | 62.2 mm (derived from the photo) |
| Traced (raw) | 180.95 x 62.23 mm |
| Pocket | 183.81 x 65.16 mm |
| Cutout depth | 20 mm |
| Bin size | 2x5 units (83.38 x 209.38 mm) |
| Clearance | 1.5 mm radial |
| Lip margin | 9.83 mm per end |
...
```
python3 ../../scripts/make_tool.py <photo> klein-11053 --length 181 --outdir .
