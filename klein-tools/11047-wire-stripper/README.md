...
| Width | 98.1 mm (derived from the photo) |
| Traced (raw) | 158.96 x 98.07 mm |
| Pocket | 161.83 x 100.96 mm |
| Cutout depth | 20 mm |
...
```
python3 ../../scripts/make_tool.py <photo> klein-11047 --length 159 --outdir .
