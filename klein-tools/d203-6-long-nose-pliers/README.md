# Klein Tools D203-6 — Long-nose pliers
...
| | |
|---|---|
| Catalogue length (nominal) | 168 mm |
| Width | 59.3 mm (derived from the photo) |
| Traced (raw) | 167.90 x 59.31 mm |
| Pocket | 170.80 x 62.25 mm |
| Cutout depth | 20 mm |
| Bin size | 2x5 units (83.38 x 209.38 mm) |
| Clearance | 1.5 mm radial |
| Lip margin | 16.34 mm per end |
...
```
python3 ../../scripts/make_tool.py <photo> klein-d203-6 --length 168 --outdir .
