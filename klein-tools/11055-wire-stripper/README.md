...
| Width | 71.9 mm (derived from the photo) |
| Traced (raw) | 180.93 x 71.89 mm |
| Pocket | 183.79 x 74.82 mm |
| Cutout depth | 20 mm |
| Bin size | 3x5 units (125.38 x 209.38 mm) |
| Clearance | 1.5 mm radial |
| Lip margin | 9.84 mm per end |
...
```
python3 ../../scripts/make_tool.py <photo> klein-11055 --length 181 --outdir .
