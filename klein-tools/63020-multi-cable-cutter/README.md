# Klein Tools 63020 — Multi-cable cutter
...
| | |
|---|---|
| Catalogue length (nominal) | 177 mm |
| Width | 57.2 mm (derived from the photo) |
| Traced (raw) | 176.93 x 57.18 mm |
| Pocket | 179.86 x 60.14 mm |
| Cutout depth | 20 mm |
| Bin size | 2x5 units (83.38 x 209.38 mm) |
| Clearance | 1.5 mm radial |
| Lip margin | 11.81 mm per end |
...
```
python3 ../../scripts/make_tool.py <photo> klein-63020 --length 177 --outdir .
