...
| | |
|---|---|
| Catalogue length (nominal) | 241 mm |
| Width | 52.9 mm (derived from the photo) |
| Traced (raw) | 240.97 x 52.90 mm |
| Pocket | 243.82 x 55.86 mm |
| Cutout depth | 20 mm |
| Bin size | 2x7 units (83.38 x 293.38 mm) |
| Clearance | 1.5 mm radial |
| Lip margin | 21.83 mm per end |
...
```
python3 ../../scripts/make_tool.py <photo> klein-63050 --length 241 --outdir .
