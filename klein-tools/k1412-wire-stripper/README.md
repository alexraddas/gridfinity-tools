# Klein Tools K1412 — Wire stripper
...
| | |
|---|---|
| Catalogue length (nominal) | 197 mm |
| Width | 61.8 mm (derived from the photo) |
| Traced (raw) | 196.97 x 61.76 mm |
| Pocket | 199.82 x 64.73 mm |
| Cutout depth | 20 mm |
| Bin size | 2x6 units (83.38 x 251.38 mm) |
| Clearance | 1.5 mm radial |
| Lip margin | 22.83 mm per end |
...
```
python3 ../../scripts/make_tool.py <photo> klein-k1412 --length 197 --outdir .
